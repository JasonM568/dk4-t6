...
export default async function Students({ searchParams }: { searchParams: Promise<{ q?: string }> }) {
  ...
  return <div className="max-w-5xl">
    ...
    <p className="mb-5 mt-1 text-sm text-gray-500">學員上課記錄卡：<strong>輸入手機號碼</strong>（或姓名、Email）就能查到這個人過去上過哪些課。<strong>手機是學員的識別鍵</strong>（同號碼＝同一人）——夫妻、親子常共用一個信箱，Email 不能拿來認人。課名寫法對照在 <a href="/admin/students/courses" className="text-indigo-600 underline">課名歸戶</a> 管理。</p>
